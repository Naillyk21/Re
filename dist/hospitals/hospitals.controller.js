...
let HospitalsController = class HospitalsController {
    ...
    createHospital(createHospitalDto) {
        return __awaiter(this, void 0, void 0, function* () {
            const { official_name, full_address, department_number, postal_code, facility_type, latitude, longitude, finess, occupancy_rate, } = createHospitalDto;
            if (!official_name || !full_address || !department_number || !postal_code || !facility_type || !latitude || !longitude) {
                throw new common_1.HttpException('Tous les champs obligatoires doivent être remplis.', common_1.HttpStatus.BAD_REQUEST);
            }
